    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-sm text-gray-600">
          Total Users: <span className="font-semibold text-[#0c9dcb]">{filteredUsers.length}</span>
        </div>
      </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#0c9dcb] to-[#26b4e0] flex items-center justify-center text-white flex-shrink-0">
                    ...
                    {/* Role */}
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Badge className={`${getRoleColor(user.role)} border px-2.5 py-1 text-xs`}>
                ...
                <div className="flex items-center gap-1">
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <Button
                      ...
                      className={currentPage === page ? "bg-[#0c9dcb] hover:bg-[#0a8bb5] text-white" : ""}
                    >
                      {page}
                    </Button>
                  ))}
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#0c9dcb] to-[#26b4e0] flex items-center justify-center">
                <Plus className="w-5 h-5 text-white" />
              </div>
              Add New User
            </DialogTitle>
            <DialogDescription>
              Create a new user account with assigned role. The user will receive login credentials.
            </DialogDescription>
          </DialogHeader>
              ...
              >
                ...
                <SelectContent>
                  {rolesList.map((role) => {
                    ...
                    else if (role === 'Supervisor') iconColor = 'text-green-600';
      ...
      <Dialog open={editUserDialogOpen} onOpenChange={handleCloseEditDialog}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-5 mt-4">
            ...
            {/* Password */}
            <div>
              <Label htmlFor="edit-password" className="text-sm font-medium text-gray-700 mb-2 block">
                Password <span className="text-red-500">*</span>
              </Label>
              <Input
                id="edit-password"
            ...
            {/* Role */}
            <div>
              <Label htmlFor="edit-role" className="text-sm font-medium text-gray-700 mb-2 block">
                Role <span className="text-red-500">*</span>
              </Label>
              <Select
                value={formData.role}
      ...
      <Dialog open={addRoleDialogOpen} onOpenChange={handleCloseAddRoleDialog}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 mt-4">
            <div>
              <Label htmlFor="new-role" className="text-sm font-medium text-gray-700 mb-2 block">
