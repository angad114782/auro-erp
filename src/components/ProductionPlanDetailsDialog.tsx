...
export function ProductionPlanDetailsDialog({
  ...
  const saveNewPlant = () => {
    ...
    setProductionPlanningData({ ...productionPlanningData, assignedPlant: newPlantName });
    setNewPlantName('');
  ...
  const saveNewVendor = () => {
    ...
    setProductionPlanningData({ ...productionPlanningData, soleVendor: newVendorName });
    setNewVendorName('');
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <span className="text-lg font-mono text-blue-600">{plan.projectCode}</span>
                  <Badge className={`${getPriorityColor(plan.priority)} text-sm px-3 py-1`}>
                    {plan.priority}
                  </Badge>
                </div>
              </div>
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide">
          <div className="px-8 py-8 space-y-5">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-gray-900">{plan.gender}</p>
                  </div>
                  <div>
              ...
              <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="text-sm font-medium text-green-900">{plan.quantity.toLocaleString('en-IN')} units</p>
                  </div>
                  <div>
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
              <h4 className="text-sm font-semibold text-blue-800 mb-3">Production Planning</h4>
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      if (value === '__add_new__') {
                        ...
                        setProductionPlanningData({ ...productionPlanningData, assignedPlant: value });
                      }
                    }}
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => setProductionPlanningData({ ...productionPlanningData, sendDate: e.target.value })}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => setProductionPlanningData({ ...productionPlanningData, receivedDate: e.target.value })}
                      className="h-9 text-sm border-blue-200 focus:border-blue-500 bg-white pl-9"
                      style={{ colorScheme: 'light' }}
                    />
                  </div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      if (value === '__add_new__') {
                        ...
                        setProductionPlanningData({ ...productionPlanningData, soleVendor: value });
                      }
                    }}
                  >
                    <SelectTrigger className="h-9 text-sm border-blue-200 focus:border-blue-500 bg-white">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => setProductionPlanningData({ ...productionPlanningData, soleReceivedDate: e.target.value })}
                      className="h-9 text-sm border-blue-200 focus:border-blue-500 bg-white pl-9"
                      style={{ colorScheme: 'light' }}
                    />
                  </div>
                ...
                {!isEditingRemarks ? (
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-md bg-green-600 hover:bg-green-700 text-white transition-colors"
                      title="Edit remarks"
                    >
                  ...
                  <div className="space-y-3">
                    <div>
                      <Label htmlFor="remarks-edit" className="text-sm font-medium text-green-800 mb-2 block">
                        Edit Remarks
                      </Label>
                      <Textarea
                        id="remarks-edit"
            ...
            <div className="flex items-center justify-end pt-4 border-t border-gray-200">
              <div className="flex items-center gap-2">
                {(plan.status === 'Planning' || plan.status === 'Capacity Allocated' || 
                  plan.status === 'Manufacturing Assigned' || plan.status === 'Process Defined' || 
                  plan.status === 'Ready for Production') && onStartProduction && (
                  <Button 
                    size="sm" 
