              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <DialogDescription className="sr-only">
                    Update daily production quantities for{" "}
                    {getCurrentStageName().toLowerCase()} stage
                  </DialogDescription>
                  <div className="flex items-center gap-4">
                        ...
                        return (
                          ...
                          >
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                              ...
                              <div className="lg:col-span-4">
                                <div className="flex items-center gap-4">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-xs text-[#0c9dcb] font-mono">
                                      {record.productionId}
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div className="lg:col-span-3">
                                <div className="text-sm text-gray-600 mb-1">
                                  Current {getCurrentStageName()} Status
                                </div>
                                <div className="space-y-1">
                                  {getStatusBadge(
                                    stageData.status,
                              ...
                              <div className="lg:col-span-3 space-y-3">
                                <div>
                                  ...
                                  <Button
                                    ...
                                    className={`w-full h-10 border-2 transition-all font-semibold shadow-sm ${
                                      activeStage === "cutting"
                                        ? "border-purple-300 bg-linear-to-r from-purple-50 to-purple-100 text-purple-700 hover:from-purple-100 hover:to-purple-200 hover:border-purple-400"
                                        : activeStage === "printing"
                                        ? "border-blue-300 bg-linear-to-r from-blue-50 to-blue-100 text-blue-700 hover:from-blue-100 hover:to-blue-200 hover:border-blue-400"
                                        : activeStage === "upper"
                                        ? "border-indigo-300 bg-linear-to-r from-indigo-50 to-indigo-100 text-indigo-700 hover:from-indigo-100 hover:to-indigo-200 hover:border-indigo-400"
                                        : activeStage === "upperREJ"
                                        ? "border-orange-300 bg-linear-to-r from-orange-50 to-orange-100 text-orange-700 hover:from-orange-100 hover:to-orange-200 hover:border-orange-400"
                                        : activeStage === "assembly"
                                        ? "border-green-300 bg-linear-to-r from-green-50 to-green-100 text-green-700 hover:from-green-100 hover:to-green-200 hover:border-green-400"
                                        : activeStage === "packing"
                                        ? "border-teal-300 bg-linear-to-r from-teal-50 to-teal-100 text-teal-700 hover:from-teal-100 hover:to-teal-200 hover:border-teal-400"
                                        : activeStage === "rfd"
                                        ? "border-emerald-300 bg-linear-to-r from-emerald-50 to-emerald-100 text-emerald-700 hover:from-emerald-100 hover:to-emerald-200 hover:border-emerald-400"
                                        : "border-purple-300 bg-linear-to-r from-purple-50 to-purple-100 text-purple-700 hover:from-purple-100 hover:to-purple-200 hover:border-purple-400"
                                    }`}
                                    onClick={() => {
                                ...
                                <div>
                                  ...
                                  >
                                    <SelectTrigger className="h-10 border-2 border-emerald-300 bg-linear-to-r from-emerald-50 to-emerald-100 hover:from-emerald-100 hover:to-emerald-200 focus:border-emerald-500 transition-all">
                            ...
                            {currentEntry.advanceTo && (
                              <div className="mt-4 p-3 bg-linear-to-r from-emerald-50 to-teal-50 rounded-lg border-2 border-emerald-300">
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      ...
                                      <div className="text-xs text-emerald-700">
                                        Product will be moved to the next
                                        production stage
                                      </div>
                                    </div>
                                  </div>
                            ...
                            {currentEntry.quantity > 0 && (
                              <div className="mt-4 p-3 bg-linear-to-r from-green-50 to-emerald-50 rounded-lg border-2 border-green-300">
                                <div className="flex items-center justify-between text-sm">
                                  <span className="text-green-700 font-medium">
                                    Will update: +{currentEntry.quantity} units
                                    for {getCurrentStageName()}
                                  </span>
                      ...
                      {filteredProductsForUpdate.length === 0 && (
                        <div className="text-center py-12">
                          ...
                          <div className="text-sm text-gray-400">
                            Try adjusting your search terms to find products to
                            update
                          </div>
                        </div>
                      )}
                      ...
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          ...
                          {[
                            ...
                            {
                              productName: "Casual Loafer - Black",
                              productCode: "PROD-004",
                              quantity: 125,
                              date: "2025-10-10",
                            },
                            {
                              productName: "High-Top Basketball - Red",
                              productCode: "PROD-005",
                              quantity: 100,
                              date: "2025-10-09",
                            },
                            {
                              productName: "Trail Running Shoe - Green",
                              productCode: "PROD-006",
                              quantity: 180,
                              date: "2025-10-09",
                            },
                            {
                              productName: "Formal Oxford - Navy",
                              productCode: "PROD-007",
                              quantity: 90,
                              date: "2025-10-08",
                            },
                            {
                              productName: "Canvas Sneaker - Gray",
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        product(s) will be updated for {getCurrentStageName()}
                      </div>
                      <div className="text-sm text-gray-600">
                        Total quantity:{" "}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <DialogDescription className="sr-only">
                        View comprehensive production details and progress
                        information
                      </DialogDescription>
                      <div className="flex items-center gap-4">
                        <span className="text-lg text-gray-600">
                        ...
                        <div className="grid grid-cols-7 gap-2">
                          {stages.map((stage, index) => {
                            ...
                            return (
                              ...
                              >
                                <div
                                  className={`w-8 h-8 mx-auto mb-2 rounded-full flex items-center justify-center text-xs ${
                                    isCompleted
                          ...
                          <div className="space-y-3">
                            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                              <div>
                                ...
                                <div className="text-sm text-gray-500">
                                  {selectedProductionRecord.type} - Premium
                                  Grade
                                </div>
                              </div>
