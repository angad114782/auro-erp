    ...
    switch (stage) {
      case "cutting":
        return {
          title: "Cutting",
          actionName: "Cutting",
          headerBg: "bg-linear-to-r from-purple-50 via-white to-purple-50",
      ...
      case "printing":
        return {
          title: "Printing",
          actionName: "Printing",
          headerBg: "bg-linear-to-r from-blue-50 via-white to-blue-50",
      ...
      case "upper":
        return {
          title: "Upper",
          actionName: "Upper",
          headerBg: "bg-linear-to-r from-indigo-50 via-white to-indigo-50",
      ...
      case "upperREJ":
        return {
          ...
          headerBg: "bg-linear-to-r from-orange-50 via-white to-orange-50",
      ...
      case "assembly":
        return {
          title: "Assembly",
          actionName: "Assembly",
          headerBg: "bg-linear-to-r from-green-50 via-white to-green-50",
      ...
      case "packing":
        return {
          title: "Packing",
          actionName: "Packing",
          headerBg: "bg-linear-to-r from-teal-50 via-white to-teal-50",
      ...
      case "rfd":
        return {
          title: "RFD",
          actionName: "RFD",
          headerBg: "bg-linear-to-r from-emerald-50 via-white to-emerald-50",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="!max-w-[85vw] !w-[85vw] max-h-[90vh] overflow-hidden p-0 m-0 top-[5vh] translate-y-0 flex flex-col">
        {/* Sticky Header */}
        <div
          className={`sticky top-0 z-50 px-8 py-6 ${stageDetails.headerBg} border-b-2 ${stageDetails.headerBorder} shadow-sm`}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              <div
                className={`w-14 h-14 ${stageDetails.iconBg} rounded-xl flex items-center justify-center shadow-lg`}
              >
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Badge
                    className={`${stageDetails.badgeBg} text-sm px-3 py-1`}
                  >
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide">
          <div className="px-8 py-8 space-y-8">
            ...
            <div className="bg-linear-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
              <div className="grid grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <div className="mt-1 text-base font-bold text-blue-600">
                    {productData.targetQuantity} pairs
                  </div>
                </div>
                <div>
                  <Label className="text-sm font-medium text-gray-600">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-orange-700">
                      ...
                      based on the minimum cut quantity across all items. To
                      reach the target of {productData.targetQuantity} pairs,
                      you need to cut more materials.
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="grid grid-cols-12 gap-6 items-center">
                        ...
                        <div className="col-span-3">
                          <div className="flex items-start gap-3">
                            <div className="w-12 h-12 bg-linear-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center shrink-0 border-2 border-gray-300">
            ...
            {/* Summary Statistics */}
            <div className="bg-linear-to-r from-gray-50 to-gray-100 border-2 border-gray-300 rounded-xl p-6">
