...
export function ProductionManagement({
  ...
  const [showStartProductionDialog, setShowStartProductionDialog] =
    useState(false);
  const [showMaterialRequisitionDialog, setShowMaterialRequisitionDialog] =
    useState(false);
  const [selectedProductionCard, setSelectedProductionCard] =
    useState<any>(null);
    ...
    },
    {
      ...
      count:
        productionOrders?.filter(
          (p) => !["Completed", "Dispatched"].includes(p.status)
        )?.length || 0,
    },
    {
      id: "completed-orders",
      ...
      count:
        productionOrders?.filter((p) =>
          ["Completed", "Dispatched"].includes(p.status)
        )?.length || 0,
    },
    {
      id: "cutting-stage",
      ...
      <Card className="shadow-lg border-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Manufacturing process tracking: Cutting → Printing → Upper →
                  Upper REJ → Assembly → Packing → RFD
                </p>
              </div>
            </div>
        ...
        <CardContent className="p-6">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center justify-between bg-linear-to-r from-gray-50 to-gray-100 p-6 rounded-xl">
              {productionStages.map((stage, index) => (
                <div key={stage.stage} className="flex items-center">
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-16 h-16 ${stage.color} rounded-full flex items-center justify-center text-white shadow-lg`}
                    >
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Managing {productionCards.length} production cards
                        </p>
                      </div>
                    </div>
                      ...
                      {productionCards.length === 0 ? (
                        <div className="text-center py-12">
                          ...
                          <h3 className="text-lg font-medium text-gray-900 mb-2">
                            No Production Cards Yet
                          </h3>
                          <p className="text-gray-600 mb-4">
                            Production cards will appear here when created from
                            R&D projects.
                          </p>
                        </div>
                      ) : (
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  <button
                                    ...
                                    onClick={() =>
                                      handleMaterialRequisition(card)
                                    }
                                  >
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Managing {tab.count} items in this category
                        </p>
                      </div>
                      <div className="flex gap-2">
                        <button
                          onClick={() =>
                            setSelectedSubModule("production-tracking")
                          }
                        ...
                        <button
                          onClick={() =>
                            setSelectedSubModule("production-analytics")
                          }
                    ...
                    <div className="mt-8 p-6 bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-4">
                          Access detailed production tracking and analytics for
                          comprehensive manufacturing insights.
                        </p>
                        <div className="flex justify-center gap-3">
                          ...
                          <button
                            onClick={() =>
                              setSelectedSubModule("production-dashboard")
                            }
