  ...
  const notifications: Notification[] = [
    {
      ...
      message:
        "Project RND0002 has exceeded the allocated budget by ₹50,000. Immediate attention required.",
    ...
    },
    {
      ...
      message:
        "Sneaker prototype for project RND0001 has received Green Seal approval. Ready for production planning.",
    ...
    },
    {
      ...
      message:
        "Designer Emily Johnson has been added to the R&D team. Please update project assignments.",
    ...
    },
    {
      ...
      message:
        "Critical shortage of premium leather material. Current stock: 45 units. Minimum required: 200 units.",
    ...
    },
    {
      ...
      message:
        "Design review meeting for Summer Collection 2024 scheduled for tomorrow at 2:00 PM.",
    ...
    },
    {
      ...
      message:
        "Project RND0004 deadline is in 3 days. Current progress: 70%. Review timeline immediately.",
    ...
    },
    {
      ...
      message:
        "Costing analysis for Bacca Bucci Formal Collection has been completed. Results available in reports.",
    ...
    },
    {
      ...
      message:
        "Scheduled system maintenance on January 25th from 2:00 AM to 4:00 AM. Plan accordingly.",
            ...
            {selectedNotification.actionRequired && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-yellow-700 text-sm">
                  This notification requires your immediate attention and
                  action.
                </p>
              </div>
            )}
