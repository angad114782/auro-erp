...
export function ProductionDashboard({
  ...
  const pendingUpperREJ =
    productionStagesData[3].planned - productionStagesData[3].completed;
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-gray-600">
          Real-time monitoring of manufacturing process: Cutting → Printing →
          Upper → Upper REJ → Assembly → Packing → RFD
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
            {productionStagesData.map((stage, index) => (
              <div key={stage.stage} className="relative">
                <div className="p-4 border rounded-lg hover:shadow-md transition-shadow bg-linear-to-br from-gray-50 to-gray-100">
                  ...
                  {stageEfficiencyData.map((stage, index) => (
                    <div key={index} className="p-4 border rounded-lg">
                      ...
                      <div className="flex justify-between items-center mt-2">
                        ...
                        <Badge
                          variant={
                            stage.efficiency >= 90 ? "default" : "destructive"
                          }
                        >
                          {stage.efficiency >= 90
                            ? "Excellent"
