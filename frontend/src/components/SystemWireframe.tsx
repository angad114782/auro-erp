  ...
  const componentLibrary = [
    ...
    },
    {
      ...
      components: [
        ...
        {
          name: "Chart",
          description: "Recharts integration",
          usage: "Data visualization",
        },
        {
          name: "Badge",
          description: "Status indicators",
          usage: "Labels and tags",
        },
      ],
    },
    {
    ...
    <div className="p-6 space-y-8 bg-linear-to-br from-gray-50 to-gray-100 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            System Wireframe & Design Documentation
          </h1>
          <p className="text-gray-600">
            Comprehensive ERP system architecture and component library
          </p>
        </div>
      ...
      <Tabs defaultValue="architecture" className="space-y-6">
        <TabsList className="grid w-fit grid-cols-5 bg-white rounded-xl p-1 shadow-md">
          <TabsTrigger value="architecture" className="px-6 py-3">
            System Architecture
          </TabsTrigger>
          <TabsTrigger value="components" className="px-6 py-3">
            Component Library
          </TabsTrigger>
          <TabsTrigger value="wireframes" className="px-6 py-3">
            Wireframes
          </TabsTrigger>
          <TabsTrigger value="design-system" className="px-6 py-3">
            Design System
          </TabsTrigger>
          <TabsTrigger value="flows" className="px-6 py-3">
            User Flows
          </TabsTrigger>
        </TabsList>
            ...
            <CardContent>
              <div className="relative bg-gray-50 rounded-xl p-8 min-h-[500px] overflow-hidden">
                ...
                {systemModules.map((module) => (
                  ...
                  >
                    <div
                      className={`${module.color} p-4 rounded-xl text-white shadow-lg hover:shadow-xl transition-shadow min-w-[140px]`}
                    >
                ...
                >
                  {systemModules.map((module) =>
                    module.connections.map((connectionId) => {
                      const targetModule = systemModules.find(
                        (m) => m.id === connectionId
                      );
              ...
              {selectedComponent && (
                <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  <h4 className="font-semibold text-blue-900 mb-2">
                    {
                      systemModules.find((m) => m.id === selectedComponent)
                        ?.title
                    }{" "}
                    Details
                  </h4>
                ...
                <CardContent>
                  <div
                    className={`bg-gray-100 rounded-xl p-4 ${
                      wireframeView === "desktop"
                        ? "aspect-video"
                        : wireframeView === "tablet"
                        ? "aspect-[4/3]"
                        : "aspect-[9/16]"
                    }`}
                  >
